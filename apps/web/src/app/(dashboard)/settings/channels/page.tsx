...
const CHANNEL_INFO: Record<string, { icon: string; name: string; color: string }> = {
  whatsapp: { icon: '💬', name: 'WhatsApp Business', color: 'border-green-700 bg-green-900/20' },
  messenger: { icon: '📘', name: 'Messenger', color: 'border-blue-700 bg-blue-900/20' },
  instagram: { icon: '📷', name: 'Instagram DM', color: 'border-pink-700 bg-pink-900/20' },
};
        ...
        .map((type) => {
          ...
          return (
            <div key={type} className="rounded-xl border border-gray-700 bg-gray-800 overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-white">Conectar {info.name}</p>
              ...
              {isOpen && (
                <div className="border-t border-gray-700 px-5 py-5 space-y-4">
                  {type === 'whatsapp' && (
                    <div className="rounded-lg bg-blue-900/30 border border-blue-700 px-4 py-3">
                      <p className="text-xs text-blue-300 font-medium mb-1">Requisitos:</p>
