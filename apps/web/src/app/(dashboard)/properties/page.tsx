...
export default function PropertiesPage() {
  ...
  const openEdit = (p: any) => {
    ...
    setForm({
      ...
      pricePerWeek: parseFloat(p.pricePerWeek) || 0,
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  <p className="text-lg font-bold text-green-400">
                    ${parseFloat(p.pricePerNight).toLocaleString('es-MX')}
                  </p>
              ...
              {p.amenities?.length > 0 && (
                <div className="flex flex-wrap gap-1 mt-2">
                  ...
                  {p.amenities.length > 5 && (
                    <span className="text-[10px] text-gray-500">+{p.amenities.length - 5}</span>
                  )}
                </div>
              )}
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="Depto Vista al Mar"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Hermoso departamento con vista al mar..."
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-xs text-gray-400">Huéspedes</label>
                  <input
                    type="number"
                    value={form.capacity}
                ...
                <div>
                  <label className="text-xs text-gray-400">Habitaciones</label>
                  <input
                    type="number"
                    value={form.bedrooms}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-xs text-gray-400">$/noche</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="text-xs text-gray-400">$/semana</label>
                  <input
                    type="number"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Av. Costera #123, Cancún"
                  className="w-full vspro-input"
                />
              </div>
              <div className="flex gap-2 items-end">
                ...
                <button
                  ...
                  className="rounded-lg border border-blue-600 px-3 py-2 text-xs text-blue-400 hover:bg-blue-900/30"
                >
                  📍 Mi ubicación
                </button>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    className="flex-1 vspro-input text-xs"
                    onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), addRule())}
                  />
                  <button
                    type="button"
                    onClick={addRule}
                    className="rounded-lg bg-gray-700 px-3 text-xs text-gray-300 hover:bg-gray-600"
                  >
                    +
                  </button>
                </div>
                {form.rules.length > 0 && (
                  <div className="space-y-1">
                    {form.rules.map((r, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between bg-gray-900 rounded-lg px-3 py-1.5 text-xs text-gray-300"
                      >
                        <span>• {r}</span>
                        <button
                          type="button"
              ...
              <div className="flex gap-3 pt-3 border-t border-gray-700">
                <button
                  type="button"
                  onClick={() => setShowForm(false)}
                  className="flex-1 rounded-lg border border-gray-600 py-2.5 text-sm text-gray-300 hover:bg-gray-700"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 rounded-lg bg-blue-600 py-2.5 text-sm text-white hover:bg-blue-700 disabled:opacity-50"
                >
